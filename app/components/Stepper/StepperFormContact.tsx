...
const StepperFormContact: React.FC<StepperProps & { steps: Step[], currentStep: number, setCurrentStep: (step: number) => void, selections: { [key: number]: string | null } }> = ({ steps, currentStep, setCurrentStep, selections }) => {
  ...
  const handleNext = async () => {
    if (!isValidEmail || !consent1 || !consent2) return; // Evitar envío si falta algo
  ...
  return (
    <div>
      ...
      <div className="mt-6 text-[11px]">
        ...
        <div className="flex justify-center items-center space-x-8 mt-3">
          <label className="flex items-center space-x-1">
            <input type="radio" name="consent1" className="input-radio" value="Acconsento" onChange={(e) => setConsent1(e.target.value)} />
            <span>Acconsento</span>
          </label>
          <label className="flex items-center space-x-1">
            <input type="radio" name="consent1" className="input-radio" value="Non Acconsento" onChange={(e) => setConsent1(e.target.value)} />
            <span>Non Acconsento</span>
          </label>
        </div>
        ...
        <div className="flex justify-center items-center space-x-8 mt-3">
          <label className="flex items-center space-x-1">
            <input type="radio" name="consent2" className="input-radio" value="Acconsento" onChange={(e) => setConsent2(e.target.value)} />
            <span>Acconsento</span>
          </label>
          <label className="flex items-center space-x-1">
            <input type="radio" name="consent2" className="input-radio" value="Non Acconsento" onChange={(e) => setConsent2(e.target.value)} />
            <span>Non Acconsento</span>
          </label>
        </div>
      </div>
