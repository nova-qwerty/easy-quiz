...
const StepperImageVertical: React.FC<StepperProps> = ({ steps, currentStep }) => {
  return (
    <div>
      ...
      <div className="flex flex-col gap-2 w-full">
        {steps[currentStep].replies?.map((option, index) => (
          <button
            key={index}
            className="border rounded-lg w-full flex flex-col items-center hover:shadow-lg transition-all card-height-triple"
          >
